...
module.exports = (function () {
   ...
   function getBlobFullName(regionContext, container, BlobPrefix, pollingCount, interval, callback) {
      ...
      blobSvc.listBlobsSegmented(container, null, function (error, result, response) {
         ...
         underscore.each(response.body.EnumerationResults.Blobs.Blob, function (blob) {

            var blobName = blob.Name.substring(blob.Name.lastIndexOf('/') + 1);

            console.log(pollingCount+' blobName-' + blobName + '  ' + BlobPrefix);
console.log(blobName.indexOf(BlobPrefix)+'  '+blobName.indexOf('.vhd'));
            if (blobName.indexOf(BlobPrefix) !=-1  && blobName.indexOf('.vhd') > 0) {
         ...
         if (pollingCount > 0) {
            ...
            setTimeout(getBlobFullName, interval,regionContext, container, BlobPrefix, pollingCount-1, interval, callback);
         }
         if (pollingCount === 0) {
            callback();
            return;
   ...
   var that = {
      ...
      createNode: function (settings, cloudServicesTestSettings, nodeIndex, callback) {
         ...
         azureRequest('PUT', settingsIp, function (err, res) {
            ...
            azureRequest('PUT', settingsNetwork, function (err, res) {
               ...
               azureRequest('PUT', settingsVm, function (err, res) {
      ...
      listNodes: function (settings, callback) {
         ...
         azureRequest('GET', settingsListVms, function (err, resListVms) {
            ...
            azureRequest('GET', settingsNetworkInterfaces, function (err, resListNetworkInterfaces) {
               ...
               azureRequest('GET', settingsPublicIpAddresses, function (err, resListIpAddresses) {
      ...
      deleteNode: function (settings, callback) {
         ...
         azureRequest('GET', settingsGetVm, function (err, resVm) {
            ...
            azureRequest('DELETE', settingsDelVm, function (err, resVm) {
      ...
      createImage: function (settings, callback) {
         ...
         azureRequest('POST', settingsStopVm, function (err, res) {
            ...
            azureRetryRequest('POST', settingsGeneralizeVm, 20, interval, function (err, res) {
            ...
            azureRetryRequest('POST', settingsImage, 20, interval, function (err, res) {
               ...
               getBlobFullName(settings.regionContext, 'system', imageName,20, interval, function (err, res) {
                  ...
                  callback(null, {rawResult: null, imageId: res});
